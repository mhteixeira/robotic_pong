...
def custom_set_arm_max_velocity(arm, percentage_speed):
        arm_check_range_belonging(percentage_speed, 1, 200)
        req = arm_services.get_max_velocity_scaling_factor_request(percentage_speed)
        resp = arm_services.set_max_velocity_scaling_factor_service.call(req)
        arm_check_result_status(resp)
