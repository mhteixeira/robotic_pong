...
while(cap.isOpened()):
	...
	if ret == True:
		...
		# Hit code
		ball_inside_hit_region = is_ball_inside_field(x, y, top_left_corner[0], top_left_corner[1], top_left_corner[0] + hit_region_width, bottom_right_corner[1])
		print(ball_inside_hit_region)
